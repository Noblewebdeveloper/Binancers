...
function EthVal(){
    ...
    return<div  className='lifewrapper'>
        Ethereum
        <img src={ethereum['image'].thumb} className='m-2'style={{width:'30px'}}/>
        <br/>
        <div  className='lifevalue'>
            <p>Live Value <span className='bold'>₦</span></p>
            <span className='bold'>{ethereum['market_data'].current_price.ngn}</span>
        </div>
        <div  className='lifevalue'>
            <p>Live Value <span className='bold'>$</span></p>
            <span className='bold'>{ethereum['market_data'].current_price.usd}</span>
        </div>
    </div>
}

export default EthVal
